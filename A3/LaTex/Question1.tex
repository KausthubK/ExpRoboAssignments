	...
	\subsection{Program Flow \& Observation Scheduling}
		...
		\begin{figure}[position = here]
			\begin{centering}
				...
				\node(dataio)[process, below of = start, yshift = -1cm]{Data I/O};
				\node(globals)[process, below of = dataio, yshift = -1cm]{Set Global Variables};
				\node(while)[decision, below of = globals]{loopflag == 1};
