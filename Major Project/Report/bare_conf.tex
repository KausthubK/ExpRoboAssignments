...
\end{abstract}
\vfill
\includegraphics[scale=0.8]{./kkimgs/EPSONMUGSHOT.jpg} % also works with logo.pdf
\vfill
\includegraphics[scale=0.8]{./kkimgs/EPSONPEEKSHOT.jpg} % also works with logo.pdf
...
This section outlines the background knowledge that was important to the setup of this project. It has been split into the paradigms and concerns that are pertinent to each of the modules.
	...
	\input{./background_AI.tex}
	\input{./background_Vision.tex}
	\input{./background_Motion.tex}	
	
\newpage
\section{Experimental Design}
The following section details the design rationale and the process followed for each part of the system.

	\input{./expDesign_AI.tex}
	\input{./expDesign_Vision.tex}
	\input{./expDesign_Motion.tex}	

\newpage
\section{Results}
	\input{results_Vision.tex}
%	\input{results_Motion.tex}

\newpage
\section{Discussion} 
	\input{discussion_AI.tex}
	\input{discussion_Vision.tex}
	\input{discussion_Motion.tex}
...
\bibitem{Canny}
Canny, John: \emph{Pattern Analysis and Machine Intelligence  },6th~ed\hskip 1em plus
0.5em minus 0.4em\relax IEEE, 1986/11.

\bibitem{MachineVision}
R.Jain,R Kasturi,B.G.Schucnk:  \emph{Machine Vision}, 1st~ed\hskip 1em plus
0.5em minus 0.4em\relax McGraw-Hill,Inc, 1995.

 
\bibitem{Niku}
Niku, Saeed B.: \emph{An Introduction to Robotics: Analysis, Control, Applications}, 2nd~ed.\hskip 1em plus 0.5em minus 0.4em\relax John Wiley and Sons, 2011.

\bibitem{MATLABOO}
Register, Andy H.: \emph{A Guide to MATLAB® Object-Oriented Programming}, \hskip 1em plus 0.5em minus 0.4em\relax SciTech Publishing Inc., 2007, Georgia Tech Research Institute

\bibitem{IEEEtex}
Shell, Michael: \emph{IEEEtran},
\hskip 1em plus 0.5em minus 0.4em\relax IEEE formatted LaTeX template
http://www.michaelshell.org/tex/ieeetran/
