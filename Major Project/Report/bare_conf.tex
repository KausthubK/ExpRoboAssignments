...
\author
{
	...
	\IEEEauthorblockA{440623630\\Email: sgun@uni.sydney.edu.au}
}
...
\begin{abstract}
%\boldmath
An implementation of an Epson robotic arm as a card sorting mechanism aimed towards situational problem solving regarding the game Concentration (A.K.A. Memory) with the intent on addressing methods to simplify decision making processes for the game Set. This setup conducts the first step in this study, namely designing a system that can play the game of Concentration
\end{abstract}
...
are developing.
	...
	\subsection{Vision Detection Implementation}

	\subsection{Motion Implementation}
